...
- Hands on experience and experimentation with new technologies
...
- Host: Fedora Server
  - This was chosen to align closely with RHEL but without hamstringing my experimentation efforts. I use RHEL extensively in a professional setting. However for the purposes of this project it is slightly too "locked down"
...
- Portainer:
  - A convenient way for me to see running containers and their health at a glance
- Fedora Cockpit:
  - Due to Carrier Grade Nat, This service (not run on docker) in conjunction with cloudflare tunnels gives me a convenient web UI in which to administer the system from outside my home network
